    ...
    const loadMaterials = async () => {
      ...
      try {
        ...
        const response = await fetch(
          'http://localhost:5000/api/study-materials/Biology'
        )

        if (!response.ok) {
          throw new Error('Failed to load Biology materials')
        }
        ...
        console.error(
          'Error loading Biology materials:',
          error
        )
    ...
    <main className="material-detail-page">
      ...
      <div className="material-detail-container">
        ...
        <div className="material-detail-header">
          ...
          <div className="material-detail-icon biology-detail-icon">
            🧬
          </div>
            ...
            {materialTypes.map((type) => (
              ...
              >
                ...
                <div className="material-type-info">
                  ...
                  <p>
                    Access Biology {type.title.toLowerCase()}.
                  </p>
